                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                        <a href="{{ url('admin/content/press-releases/delete/'.$post->id) }}"  onclick="return confirm('Are you sure you want to delete this item?');">
                                            X Delete
                                        </a>
                                </div>
                            </div>
                            ...
                            <br/>
                            <form action="{{ url('admin/content/press-releases/update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <input type="text" class="form-control datetimepicker" readonly placeholder="" required name="publish_date" value="{{ $date }}">
                                        </div>
                                    </div>
                                </div>
