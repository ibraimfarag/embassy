                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                        <a href="{{ url('admin/content/newsletters-media/delete/'.$post->id) }}"  onclick="return confirm('Are you sure you want to delete this item?');">
                                            X Delete
                                        </a>
                                </div>
                            </div>
                            ...
                            <br/>
                            <form action="{{ url('admin/content/newsletters-media/update') }}" method="post" enctype="multipart/form-data">
                                @csrf
